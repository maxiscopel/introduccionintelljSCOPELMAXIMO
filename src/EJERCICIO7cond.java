...
public class EJERCICIO7cond {
    public static void main(String[] args) {
        ...
        System.out.println("¿Cuál es tu estado de animo? (feliz, triste, energico, relajado)");
        ...
        if (estadoAnimo.equals("feliz")) {
            ...
            System.out.println("Estado de animo no reconocido. Intenta con 'feliz', 'triste', 'energico' o 'relajado'.");
        }
}
